...
#' result <- calc_oxygen_saturation(temp = 25, do_measured = 5.0,
#'                                  salinity = 35, depth = 20)
#' print(result)
#'
...
#' result <- calc_oxygen_saturation(temp = df$tem,
#'  do_measured = df$oxy,
#'  salinity = 35,
#'  depth = df$depth)
#' df <- cbind(df, result)
...
#' @importFrom stats approx filter na.omit sd
